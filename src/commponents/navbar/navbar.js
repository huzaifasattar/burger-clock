...
const Navbar = ({ isCartOpen, setIsCartOpen }) => {
  ...
  return (
    <nav className="grid grid-flow-row-reverse lg:grid-flow-row  bg-black text-white relative ">
      ...
      <div className="flex justify-end mr-6 z-50  lg:absolute fixed right-[30px] bottom-[50px] lg:top-[30px] lg:right-[40]">
        <div
        ...
        >
          ...
          <span className="rounded-full bg-amber-400 text-white absolute py-0.5 px-2 right-[-15px] top-[-15px] lg:top-[-20px] border z-30">
            {productCount}
          </span>
        </div>
      </div>
